...
# NOTE: the HermesBench trend view is a dashboard plugin
# (plugins/hermesbench/dashboard/) — its API mounts at
# /api/plugins/hermesbench/ via _mount_plugin_api_routes() and its tab at
# /hermesbench is an SPA route. No hardcoded route here.
