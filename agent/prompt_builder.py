...
KANBAN_GUIDANCE = (
    ...
    "into child tasks AND parks your task as their fan-in anchor, then "
    "re-dispatches you once EVERY child completes so you can judge results and "
    "finish or spawn more. **Do NOT call `kanban_complete` in the turn you "
    "decompose** — complete only after re-dispatch. (Plain `kanban_create` is "
    "for ad-hoc single follow-ups.) Do NOT execute the work yourself; your job "
    "is routing, not implementation.\n"
    "\n"
    "## Do NOT\n"
    "\n"
