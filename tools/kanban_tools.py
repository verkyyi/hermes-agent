...
def _handle_create(args: dict, **kw) -> str:
    ...
    # Front-desk routing invariant (default profile must assign to 'orchestrator')
    # now lives in the opt-in `kanban-orchestrator-routing` plugin as a
    # pre_tool_call hook — see docs/LOCAL_PATCHES.md #6. Kept out of this hot
    # upstream file to shrink the merge surface; enable the plugin via
    # plugins.enabled for the guard to be active.
    body = args.get("body")
